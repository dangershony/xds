...
namespace NBitcoin
{
    ...
    {
        /// <summary>
        ///     How many blocks should be on top of a block that includes a coinbase transaction until its outputs are considered
        ///     spendable.
        /// </summary>
        ...
        /// <summary>
        ///     Maximal length of reorganization that the node is willing to accept, or 0 to disable long reorganization
        ///     protection.
        /// </summary>
        ...
        ///     To allow such data to be in the coinbase we use this flag, a POS network that already has that limitation will use
        ///     the coinbase input instead.
        /// </remarks>
